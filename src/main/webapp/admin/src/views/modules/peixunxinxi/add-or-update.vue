<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="培训标题" prop="peixunbiaoti">
					<el-input v-model="ruleForm.peixunbiaoti" placeholder="培训标题" clearable  :readonly="ro.peixunbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="培训标题" prop="peixunbiaoti">
					<el-input v-model="ruleForm.peixunbiaoti" placeholder="培训标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="培训地点" prop="peixundidian">
					<el-input v-model="ruleForm.peixundidian" placeholder="培训地点" clearable  :readonly="ro.peixundidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="培训地点" prop="peixundidian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="培训内容" prop="peixunneirong">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.peixunneirong" label="培训内容" prop="peixunneirong">
                    <span :style='{"padding":"0 20px","color":"inherit","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}' v-html="ruleForm.peixunneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.peixunneirong = this.ruleForm.peixunneirong.replace(reg,'../../../ssmi589h5mo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
