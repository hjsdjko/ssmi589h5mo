	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="打卡时间" prop="dakashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.dakashijian" label="打卡时间" prop="dakashijian">
					<el-input v-model="ruleForm.dakashijian" placeholder="打卡时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="打卡地点" prop="dakadidian">
					<el-input v-model="ruleForm.dakadidian" placeholder="打卡地点" clearable  :readonly="ro.dakadidian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="打卡地点" prop="dakadidian">
					<el-input v-model="ruleForm.dakadidian" placeholder="打卡地点" readonly></el-input>
				</el-form-item>
			...
			<el-form-item :style='{"padding":"0","margin":"30px 0","alignItems":"center","textAlign":"center","display":"flex","width":"100%","perspective":"320px","-webkitPerspective":"320px","fontSize":"48px","justifyContent":"flex-start"}' class="btn">
				<el-button class="btn2" v-show="!faceMatchFlag" v-if="type!='info'" type="success" @click="faceMatchHandle">
					<span class="icon iconfont icon-renlian11" :style='{"margin":"0 2px","fontSize":"18px","color":"inherit","display":"none"}'></span>
					人脸识别
				</el-button>
