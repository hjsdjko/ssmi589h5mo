	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="职务" prop="zhiwu">
					<el-select :disabled="ro.zhiwu" v-model="ruleForm.zhiwu" placeholder="请选择职务" >
						<el-option
							v-for="(item,index) in zhiwuOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
