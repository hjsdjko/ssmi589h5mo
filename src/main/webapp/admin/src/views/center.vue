<template>
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yuangong'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yuangong'"  label="姓名" prop="xingming">
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yuangong'"  label="手机" prop="shouji">
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="flag=='yuangong'"  label="职务" prop="zhiwu">
          <el-select v-model="ruleForm.zhiwu"  placeholder="请选择职务">
            <el-option
                v-for="(item,index) in yuangongzhiwuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
  ...
  mounted() {
    ...
    this.$http({
      url: `option/zhiwuxinxi/zhiwu`,
      method: "get"
    }).then(({ data }) => {
      if (data && data.code === 0) {
        this.yuangongzhiwuOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
